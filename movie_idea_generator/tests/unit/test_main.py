...
class TestMain:
    ...
    def test_generate_movie_idea(
        ...
        mock_recommendation_agent.create.return_value = (
            mock_recommendation_agent_instance
        )

        mock_genre_analyzer.analyze_genres.return_value = "Mock genre analysis task"
        mock_recommendation_agent.get_recommendations.return_value = (
            "Mock recommendation task"
        )
        mock_idea_generator.generate_movie_idea.return_value = (
            "Mock idea generation task"
        )
